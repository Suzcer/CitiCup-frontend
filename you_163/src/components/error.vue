      ...
      <div class="subscribe wrapper">
        <div class="subscribe-w3lsbottom text-center">
          ...
          <a class="play-icon popup-with-zoom-anim btn" href="#p1">
            Subscribe</a>
          <a class="theme-button btn" href="index.html">
            Back to Home</a>
        </div>
        <!-- copyright -->
        <div class="copy-right text-center">
          <p>Copyright &copy; 2022.23C All rights reserved.<a target="_blank" href=""></a></p>
        </div>
        <!-- //copyright -->
      </div>
    </div>
...
/*-- main --*/
.mainw3.form {
  background: url(../assets/error-bg.jpg) no-repeat center;
