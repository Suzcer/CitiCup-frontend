  ...
  <div v-loading="loading">
    ...
    <div :style="{backgroundImage: 'url(' + img + ')'}" class="bgimg">
      ...
      <router-link to="/" class="myreturn">
        <svg t="1647703971703" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="2028" width="16" height="16">
          <path
